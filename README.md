# Introduction
This ```README``` illustrates how to install and run the docker version of iBEAT V2.0 pipeline, which is an infant-dedicated structural imaging processing pipeline for infant brain MR images. More detail of the pipeline can be referred to [iBEAT V2.0 Cloud](www.ibeat.cloud). 
...
Currently, the latest container tag is ```release100```, which is an initial release of our iBEAT V2.0 pipeline. We will update this regularly.
